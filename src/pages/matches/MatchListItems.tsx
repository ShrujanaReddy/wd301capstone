      ...
      {liveMatches.map((match: any, index: number) => (
        ...
        >
          <div className="flex justify-between items-center mb-2">
            ...
            <button
              className="text-sm text-black bg-gray-200 hover:text-gray-800 dark:hover:text-white border border-gray-500 dark:border-gray-700 rounded-lg p-1 px-2 ml-2 hover:bg-white"
